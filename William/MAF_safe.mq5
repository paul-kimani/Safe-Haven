...
input double TrailingStopLevel = 30; // Trailing Stop Level (%) (0: Disable)
input double EquityDrawdownLimit = 10; // Equity Drawdown Limit (%) (0: Disable)
...
input int GridMaxLvl = 1; // Grid Max Levels
...
input int SpreadLimit = 20; // Spread Limit (Points) (-1: Disable)
